...
interface PasienDeleteModalProps {
  isOpen: boolean;
  pasienName?: string;
  submitting: boolean;
  onClose: () => void;
...
export const PasienDeleteModal: React.FC<PasienDeleteModalProps> = ({
  isOpen,
  pasienName,
  submitting,
  onClose,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-xs animate-in fade-in duration-150">
      <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl transition-all text-center">
        ...
        <h3 className="text-base font-bold text-gray-900">Konfirmasi Hapus Pasien</h3>
        <p className="mt-1 text-xs text-gray-500">
          Apakah Anda yakin ingin menghapus data pasien{" "}
          <span className="font-semibold text-gray-800">"{pasienName}"</span>? Tindakan ini tidak dapat dibatalkan.
        </p>
...
export default PasienDeleteModal;
