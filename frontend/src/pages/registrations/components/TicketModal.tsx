      ...
      <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-2xl transition-all text-center space-y-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 inline-flex items-center justify-center gap-1.5 rounded-lg border border-gray-200 bg-white py-2 text-xs font-semibold text-gray-700 hover:bg-gray-50"
          >
